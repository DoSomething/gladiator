...
class Correspondence
{
    ...
    protected static $defaultMessages = [
        [
            ...
            'body' => "Woohoo, so glad you signed up for my :campaign_title: competition, :first_name:! Feel free to get a head start on the competition by working towards the greatest number of :reportback_noun: :reportback_verb: as you can. \n\rI will be in touch with you with more info in the next few days. Excited to watch you climb the leaderboard and crush the competition! \n\r:sender_name:",
            'pro_tip' => null,
        ],
        [
            'type' => 'info',
        ...
        [
            ...
            'body' => "I noticed you haven’t upload a picture of your :reportback_noun: :reportback_verb: into the :campaign_title: website yet. Just wanted to see if everything is ok! Even if you can't hit your goal, just a few :reportback_noun: can make a huge difference. \n\rIf you are able, you still have until Sunday night for the next update! Take a picture and upload your photo right here. \n\rLet me know if I can help you, :first_name:. \n\r:sender_name:",
            'pro_tip' => null,
        ],
        [
            'type' => 'reminder',
