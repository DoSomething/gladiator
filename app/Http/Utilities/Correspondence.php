...
class Correspondence
{
    ...
    protected static $defaultMessages = [
        ...
        [
            'type' => 'reminder',
            'key' => '2',
            'label' => 'Reminder for second submission due',
        ...
        [
            'type' => 'reminder',
            'key' => '3',
            'label' => 'Reminder for third submission due',
        ...
        [
            'type' => 'leaderboard',
            'key' => '3',
            'label' => 'Here are the :campaign_name competition winners!',
            'subject' => 'Leaderboard update #2 for the :campaign_name competition!',
